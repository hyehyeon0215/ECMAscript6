...
올라가는 현상이었다면 밑에 결과는 undefined가 아니라 test가 담겨야 합니다
...
// 에크마 6 문법에서 호이스팅 방지를 위해서 let이라는 변수선언을 만듦
// console.log(info);
// let info = "test";
/*
...
// if (true) {
//     var local1 = "일반 코드 블록안에서의 지역변수";
// }
// console.log(local1);

/*
일반 함수의 코드블록에서는 지역변수 scope가 유지가됩니다 즉 구역밖에서는
변수가 정의되지 않습니다
하지만 일반 조건문이나 반복문 같은 코드블록안에서는 var로 선언된 지역변수는
호이스팅으로 전역화 됩니다
*/

// if (true) {
//     let local1 = "일반 코드 블록안에서의 지역변수";
// }
// console.log(local1);
// //let으로 선언하게되면 호이스팅이 극복되어 정상적인 scope를 가집니다
...
반복이 일어나면서 i++로 인해서 i는 3이된채 for (var i = 0; i < btns.length; i++)을 만남
